...
list_music_all.push(
  new createObjectMusic(
    ...
    "Dans Les Alpes (128)",
    "Majid Entezami",
    "Photo_singer/13-MajidEntezami-DansLesAlpes-1.jpg",
    "List_music/MajidEntezami-DansLesAlpes.mp3",
    "02:16",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "imagine",
    "john Lenon",
    "Photo_singer/john-lenon.jpg",
    "List_music/JohnLenon-Imagine.mp3",
    "03:07",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "arosak koki",
    "forgh farokhzad",
    "Photo_singer/forough-farrokhzad.jpg",
    "List_music/frogh-farokhzad.mp3",
    "02:28",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "aye hai zamini",
    "forgh farokhzad",
    "Photo_singer/forough-farokhzad2.jpg",
    "List_music/frogh_farokhzad2.mp3",
    "04:58",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "Photo_singer/fereydoun_Farrokhzad.jpg",
    "List_music/Fereydoun_Farrokhzad-Harfamo-Bavar-Bekoneh.mp3",
    "04:41",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "McGowan_Mad_Girls",
    "Carol Anne",
    "Photo_singer/Carol_Anne_McGowan_Mad_Girls.jpg",
    "List_music/Carol_Anne_McGowan_Mad_Girls.mp3",
    "02:15",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "Dar Khyal",
    "Behrokh Shoorvarzi",
    "Photo_singer/Behrokh-Shoorvarzi-Dar-Khyal-musiclazem.jpg",
    "List_music/Behrokh_Shoorvarzi-Dar-Khyal.mp3",
    "02:25",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "Dkhonak andam ke ",
    "ghazal shakeri",
    "Photo_singer/ghazal-shakeri.jpeg",
    "List_music/Dkhonakandamkeneshinim.mp3",
    "04:20",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "People",
    "Kat Frankie",
    "Photo_singer/Kat-Frankie.jpg",
    "List_music/Kat-Frankie-People.mp3",
    "05:35",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "Go zar",
    "unknown",
    "Photo_singer/takhta_jamshed.jpg",
    "List_music/music_gozar.mp3",
    "05:55",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "Marge Nazli",
    "Shahin Najafi",
    "Photo_singer/Shahin-Najafi-photo-by-Amin-Khelghat….jpg",
    "List_music/ShahinNajafi_Marge-Nazli.mp3",
    "04:30",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "life ",
    "unknown",
    "Photo_singer/rock.jpg",
    "List_music/music_life.mp3",
    "03:04",
    "white"
  )
);
list_music_all.push(
  new createObjectMusic(
    ...
    "On the Nature",
    "Max Richter",
    "Photo_singer/TheBlueNotebooks-Cover-Web.jpg",
    "List_music/On-the-Nature-of-Daylight.mp3",
    "06:11",
    "white"
  )
);
...
function fanc_heart_color() {
  if (left_heart.classList.contains("left_color_heart")) {
    ...
    ).findIndex((iteam) => (iteam = iteam_selected_id));
...
left_icone_next.addEventListener("click", () =>
  animat_click_btn(
    left_icone_next,
    !isSHuffled ? fanc_next : fanc_original_shuffled
  )
);
...
left_icone_previous.addEventListener("click", () =>
  animat_click_btn(
    left_icone_previous,
    !isSHuffled ? fanc_previous : fanc_original_shuffled
  )
);
